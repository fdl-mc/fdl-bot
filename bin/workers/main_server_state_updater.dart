...
Future<void> updateMainStats(Nyxx bot) async {
  final stateChannel = await bot.fetchChannel<TextGuildChannel>(statsChannelId);
  final message = await stateChannel.fetchMessage(mainStatsMessageId);
  ...
  await Future.doWhile(() async {
    try {
      ...
      final embed = EmbedBuilder()
        ...
        ..addField(name: 'Айпи', content: 'play.fdl-mc.ru', inline: true)
      ...
      await message.edit(MessageBuilder()
        ..appendBold('Статистика основного сервера:')
        ..embeds = [embed]);
    } catch (e) {
      print(e);
      await message.edit(
